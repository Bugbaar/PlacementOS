  ...
  if (canApply) {
    return (
      <button
        ...
        onClick={onApply}
        disabled={submitting}
        className="inline-flex items-center gap-1.5 rounded-lg bg-cta-500 px-4 py-2 text-sm font-medium text-white shadow-sm transition hover:bg-cta-600 focus:outline-none focus:ring-2 focus:ring-cta-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60"
      >
