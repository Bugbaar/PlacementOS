...
const skillGapService_1 = require("./skillGapService");
// Weights
...
const calculateMatchScore = (student, opportunity) => {
    const eligibility = (0, eligibilityService_1.checkEligibility)(student, opportunity);
    const { matchedSkills, missingSkills } = (0, skillGapService_1.analyzeSkillGap)(student.skills, opportunity.requiredSkills);
